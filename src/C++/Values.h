...
namespace FIX
{
  ...
  const char SessionRejectReason_INVALID_TAG_NUMBER_TEXT[] = "Unknown Field";
  const char SessionRejectReason_REQUIRED_TAG_MISSING_TEXT[] = "Missing required Field";
  const char SessionRejectReason_TAG_NOT_DEFINED_FOR_THIS_MESSAGE_TYPE_TEXT[] = "Tag not defined for message type";
